...
- (NSArray<NSString *> *)supportedEvents {
	return @[@"APP_INSTALLED", @"APP_UPDATED", @"APP_STARTED", @"DEEPLINK_OPENED", @"PRESENTATION_VIEWED", @"LOGIN_TAPPED", @"PURCHASE_FROM_STORE_TAPPED", @"PURCHASE_TAPPED", @"PURCHASE_CANCELLED", @"IN_APP_PURCHASING", @"IN_APP_PURCHASED", @"IN_APP_RENEWED", @"RECEIPT_CREATED", @"RECEIPT_VALIDATED", @"RECEIPT_FAILED", @"RESTORE_STARTED", @"IN_APP_RESTORED", @"RESTORE_SUCCEEDED", @"RESTORE_FAILED", @"STORE_PRODUCT_FETCH_FAILED", @"IN_APP_DEFERRED", @"IN_APP_PURCHASE_FAILED", @"LINK_OPENED", @"SUBSCRIPTIONS_LIST_VIEWED", @"SUBSCRIPTION_DETAILS_VIEWED", @"SUBSCRIPTION_CANCEL_TAPPED", @"SUBSCRIPTION_PLAN_TAPPED", @"CANCELLATION_REASON_PUBLISHED"];
}
